			...
			<div class="container">
				...
				<div class="row skills">
					...
					<div class="col-sm-6 col-md-3 text-center">
						...
						<h2 class="text-center">Illustrator</h2>
					</div>
					<div class="col-sm-6 col-md-3 text-center">
		...
		<section id="portfolio" class="dark-bg padding-top-bottom">
			...
			<div class="container">
				...
				<header class="section-header text-center">
					...
					<h1 class="scrollimation scale-in">My Recent Work</h1>
				...
				<div id="projects-container">
					...
					<article class="project-item web">
						...
						<div class="sr-only project-description"
							...
							<p class="text-right"><a class="btn btn-meflat icon-right" target="_blank" href="http://mathewsinc.com">Visit Website<i class="fa fa-arrow-right"></i></a></p>
						</div>

					</article>
					<article class="project-item web">

						<img class="img-responsive project-image" src="assets/seriesfest/sf-thumb.jpg"  alt="Mathews Inc homepage"><!--Project thumb -->
						...
						<div class="sr-only project-description"
							...
							data-images="assets/seriesfest/sf-05.jpg, assets/seriesfest/sf-03.jpg, assets/seriesfest/sf-02.jpg, assets/seriesfest/sf-01.jpg, assets/seriesfest/sf-06.jpg"
							...
							<p class="text-right"><a class="btn btn-meflat icon-right" target="_blank" href="http://seriesfest.com">Visit Website<i class="fa fa-arrow-right"></i></a></p>
						</div>
					...
					<article class="project-item web">
						...
						<div class="sr-only project-description"
							...
							<p class="text-right"><a class="btn btn-meflat icon-right" target="_blank" href="http://fourwindsinteractive.com">Visit Website<i class="fa fa-arrow-right"></i></a></p>
						</div>
								...
								<div class="row">
									<div class="col-md-8 col-md-offset-2">
										<div class="image-wrapper">
											...
											<a id="sdbr-url" href="#url"><div class="screen"></a></div>
										</div>
									</div>
								</div>
							</div>
