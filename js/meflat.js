$(document).ready(function() {
	...
	$('.project-item').click(function(e){
		...
		var elem = $(this),
			...
			imgUrl = elem.find('.project-description').data('url').split(',');

			for (var i = 0; i < slides.length; ++i) {
				slidesHtml = slidesHtml + '<li><a href="'+imgUrl[i]+'" target="_blank"><img src='+slides[i]+' alt=""></a></li>';
		}
		
		// for (var i = 0; i < slides.length; ++i) {
		// 	slidesHtml = slidesHtml + '<a href="'+imgUrl[i]+'"><li><img src='+slides[i]+' alt=""></li></a>';
		// }
