			...
			<div class="container masonry-wrapper scrollimation fade-in">
				...
				<div id="projects-container">
					...
					<article class="project-item graphic">
						...
						>
							<p>The above projects were all done in InDesign.</p>
							<p>Here Juli used her typographic skills to create attractive headlines and text-based presentations that would catch the reader's eye. </p>
